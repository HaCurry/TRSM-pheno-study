...
if __name__ == "__main__":
    ...
    dictBP2 = twoDPlot.pandasDynamicReader('compiled_AtlasBP2_check_prel_Mproc.tsv', ['ms', 'mx', 'ObservedLimit', 'x_H3_H1H2_SM_tot', 'x_H3_H1H2_SM_1', 'x_H3_H1H2_SM_2'])
    twoDPlot.exclusionCheck(dictBP2['ObservedLimit'], dictBP2, ['x_H3_H1H2_SM_tot', 'x_H3_H1H2_SM_1', 'x_H3_H1H2_SM_2'], 10**(-8))
    ...
    x = dictBP2['ms']
    y = dictBP2['mx']
    z = dictBP2['ObservedLimit']/dictBP2['x_H3_H1H2_SM_1']
    ...
    x = dictBP3['ms']
    y = dictBP3['mx']
    z = dictBP3['ObservedLimit']/dictBP3['x_H3_H1H2_SM_1']
    ...
    x = dictBP5['ms']
    y = dictBP5['mx']
    z = dictBP5['ObservedLimit']/dictBP5['x_H3_H1H2_SM_1']
