...
if __name__ == '__main__':
    ...
    BP2_mH1, BP2_mH2, BP2_mH3, BP2_x_H3_H1H2 = twoDPlot.kineticExcluder(BP2_mH1, BP2_mH2, BP2_mH3, BP2_x_H3_H1H2)
    ...
    BP3_mH1, BP3_mH2, BP3_mH3, BP3_x_H3_H1H2 = twoDPlot.kineticExcluder(BP3_mH1, BP3_mH2, BP3_mH3, BP3_x_H3_H1H2) 
    ...
    twoDPlot.plotAuxTitleAndBounds2D(r"BP2: $\Gamma(h_{2})/M_{2}$", r"$M_{1}$ [GeV]", r"$M_{3}$ [GeV]", r'$\Gamma_{h_{2}}/M_{2}$', xlims=(1, 124), ylims=(126, 500))
    # plt.title(r"BP2: $\Gamma_{h_{3}}/M_{3}$")
    # plt.colorbar(label=r'$\Gamma_{h_{3}}/M_{3}$', format='{x:.3f}')
    ...
    twoDPlot.plotAuxTitleAndBounds2D(r"BP3: $\Gamma(h_{2})/M_{2}$", r"$M_{2}$ [GeV]", r"$M_{3}$ [GeV]", r'$\Gamma_{h_{2}}/M_{2}$', xlims=(126, 500), ylims=(255, 650), cbarfmt='{x:.3f}')
    ...
    twoDPlot.plotAuxTitleAndBounds2D(r"BP2: $\Gamma(h_{1})/M_{1}$", r"$M_{1}$ [GeV]", r"$M_{3}$ [GeV]", r'$\Gamma_{h_{1}}/M_{1}$', xlims=(1, 124), ylims=(126, 500))
    # plt.title(r"BP2: $\Gamma_{h_{3}}/M_{3}$")
    # plt.colorbar(label=r'$\Gamma_{h_{3}}/M_{3}$', format='{x:.3f}')
    ...
    # twoDPlot.plotAuxTitleAndBounds2D(r"BP3: $\Gamma(h_{1})/M_{1}$", r"$M_{2}$ [GeV]", r"$M_{3}$ [GeV]", r'$\Gamma_{h_{1}}/M_{1}$', xlims=(126, 500), ylims=(255, 650))
    plt.xlim(126, 500)
    plt.ylim(255, 650)
    plt.colorbar()
    plt.tight_layout()
