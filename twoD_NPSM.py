...
if __name__ == '__main__':
    ...
    twoDPlot.plotAuxTitleAndBounds2D(r"BP2: $\sigma(X\to S(bb) H(\gamma\gamma))$ with $M_{S}$, $M_{X}$ free", r"$M_{S}$", r"$M_{X}$", 'test', xlims=(1, 124), ylims=(126, 500))
    ...
    twoDPlot.plotAuxTitleAndBounds2D(r"BP2: $\sigma(X\to S(\gamma\gamma)H(bb) )$ with $M_{S}$, $M_{X}$ free", r"$M_{S}$", r"$M_{X}$", 'test', xlims=(1, 124), ylims=(126, 500))
    ...
    twoDPlot.plotAuxTitleAndBounds2D(r"BP2: $\sigma(X\to S(bb) H(\gamma\gamma)) / \sigma(X\to S(\gamma\gamma) H(bb))$ with $M_{S}$, $M_{X}$ free", r"$M_{S}$", r"$M_{X}$", 'test', xlims=(1, 124), ylims=(126, 500))
    ...
    twoDPlot.plotAuxTitleAndBounds2D(r"BP3: $\sigma(X\to S(bb)H(\gamma\gamma))$ with $M_{S}$, $M_{X}$ free", r"$M_{S}$", r"$M_{X}$", 'test', xlims=(126, 500), ylims=(255, 650))
    ...
    twoDPlot.plotAuxTitleAndBounds2D(r"BP3: $\sigma(X\to S(\gamma\gamma)H(bb))/\sigma(X\to S(bb)H(\gamma\gamma))$ with $M_{S}$, $M_{X}$ free", r"$M_{S}$", r"$M_{X}$", 'test', xlims=(126, 500), ylims=(255, 650))
