...
if __name__ == '__main__':
    ...
    paths = directorySearcher('/eos/user/i/ihaque/RobensMax/RobensMax_configure5', '/**/*_calculation.tsv')
    # print(paths)
    config.maxCompiler(paths, '/eos/user/i/ihaque/RobensMax/RobensMax_configure5/RobensMax_All_Max.tsv', 
                       'pp_X_H1H2_bbgamgam', 'pp_X_H1H1_bbgamgam', 'pp_X_H2H2_bbgamgam')

    config.maxCompiler(paths, '/eos/user/i/ihaque/RobensMax/RobensMax_configure5/RobensMax_H1_bb_H2_gamgam_Max.tsv', 
                       'pp_X_H1_bb_H2_gamgam')

    config.maxCompiler(paths, '/eos/user/i/ihaque/RobensMax/RobensMax_configure5/RobensMax_H1_gamgam_H2_bb_Max.tsv', 
                       'pp_X_H1_gamgam_H2_bb')

    config.maxCompiler(paths, '/eos/user/i/ihaque/RobensMax/RobensMax_configure5/RobensMax_H1H1_bbgamgam_Max.tsv', 
                       'pp_X_H1H1_bbgamgam')

    config.maxCompiler(paths, '/eos/user/i/ihaque/RobensMax/RobensMax_configure5/RobensMax_H2H2_bbgamgam_Max.tsv', 
                       'pp_X_H2H2_bbgamgam')
