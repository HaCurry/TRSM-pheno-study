...
if __name__ == '__main__':
    ...
    paths = directorySearcher('/eos/user/i/ihaque/testing/AtlasLimitsMax_OnlySingles/AtlasLimitsMax_configure_OnlySingles', '/**/output_*.tsv')
    print(paths)
    config.calculator(paths, 'bb', 'gamgam')

    #  find the max for each dataId and save it in AtlasLimitsMax_max
    paths = directorySearcher('/eos/user/i/ihaque/testing/AtlasLimitsMax_OnlySingles/AtlasLimitsMax_configure_OnlySingles', '/**/*_calculation.tsv')

    config.maxCompiler(paths, '/eos/user/i/ihaque/testing/AtlasLimitsMax_OnlySingles/AtlasLimitsMax_configure_OnlySingles/AtlasLimitsMax_H1_bb_H2_gamgam_Max.tsv', 
                       'pp_X_H1_bb_H2_gamgam', 
                       limitsKey='ObservedLimit')

    config.maxCompiler(paths, '/eos/user/i/ihaque/testing/AtlasLimitsMax_OnlySingles/AtlasLimitsMax_configure_OnlySingles/AtlasLimitsMax_H1_gamgam_H2_bb_Max.tsv', 
    ...
    df_H1_bb_H2_gamgam = pandas.read_table('/eos/user/i/ihaque/testing/AtlasLimitsMax_OnlySingles/AtlasLimitsMax_configure_OnlySingles/AtlasLimitsMax_H1_bb_H2_gamgam_Max.tsv')
    ...
    df_H1_gamgam_H2_bb = pandas.read_table('/eos/user/i/ihaque/testing/AtlasLimitsMax_OnlySingles/AtlasLimitsMax_configure_OnlySingles/AtlasLimitsMax_H1_gamgam_H2_bb_Max.tsv')
