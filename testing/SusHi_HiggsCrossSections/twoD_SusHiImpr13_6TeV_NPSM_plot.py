...
if __name__ == '__main__': 
    ...
    # normSM set to the HH cross section at 13.6 TeV according to
    ...
    # BP2 13.6 TeV gg -> H3 -> H1(bb) H2(gamgam)

    x, y, z, xi, yi = twoDPlot.plotAuxVar2D(ScannerS_BP2_13_6['mH1'],
                                            ScannerS_BP2_13_6['mH3'],
                                            ScannerS_BP2_13_6['x_H3_H1_bb_H2_gamgam'])
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(pathPlots, '13_6TeV', 'BP2',
                '13_6TeV_BP2_XS_XSH_bbgamgam_1.pdf'))
    plt.close()

    del x, y, z, xi, yi


    # BP2 13.6 TeV gg -> H3 -> H1(gamgam) H2(bb)

    x, y, z, xi, yi = twoDPlot.plotAuxVar2D(ScannerS_BP2_13_6['mH1'],
                                            ScannerS_BP2_13_6['mH3'],
                                            ScannerS_BP2_13_6['x_H3_H1_gamgam_H2_bb'])
    zi = scipy.interpolate.griddata((x, y), z, (xi, yi), method='linear')
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(pathPlots, '13_6TeV', 'BP2',
                '13_6TeV_BP2_XS_XSH_bbgamgam_2.pdf'))
    plt.close()
    ...
    # BP3 13.6 TeV gg -> H3 -> H1(bb) H2(gamgam)

    x, y, z, xi, yi = twoDPlot.plotAuxVar2D(ScannerS_BP3_13_6['mH2'],
                                            ScannerS_BP3_13_6['mH3'],
                                            ScannerS_BP3_13_6['x_H3_H1_bb_H2_gamgam'])
    zi = scipy.interpolate.griddata((x, y), z, (xi, yi), method='linear')
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(pathPlots, '13_6TeV', 'BP3',
                '13_6TeV_BP3_XS_XSH_bbgamgam_1.pdf'))
    plt.close()

    del x, y, z, xi, yi


    ## BP3 13.6 TeV gg -> H3 -> H1(gamgam) H2(bb)

    x, y, z, xi, yi = twoDPlot.plotAuxVar2D(ScannerS_BP3_13_6['mH2'],
                                            ScannerS_BP3_13_6['mH3'],
                                            ScannerS_BP3_13_6['x_H3_H1_gamgam_H2_bb'])
    zi = scipy.interpolate.griddata((x, y), z, (xi, yi), method='linear')
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(pathPlots, '13_6TeV', 'BP3',
                '13_6TeV_BP3_XS_XSH_bbgamgam_2.pdf'))
    plt.close()
    ...
    ScannerS_BP2_H1H2_13_6, ScannerS_BP2_H1H1_13_6, ScannerS_BP2_H2H2_13_6 = TRSM.ppXNPSM_massfree(path13_BP2,
    ...
    ScannerS_BP3_H1H2_13_6, ScannerS_BP3_H1H1_13_6, ScannerS_BP3_H2H2_13_6 = TRSM.ppXNPSM_massfree(path13_BP3,
                                                                                       'mH1', 'mH2', 'mH3', 'bb', 'gamgam',
                                                                                       normalizationSM=1, run3=True,
                                                                                       pathRun3Data=path13_6,
                                                                                       keyMassRun3='mass',
    ...
    TRSM.comparer(ScannerS_BP2_13_6, ScannerS_BP2_H1H2_13_6)
    TRSM.comparer(ScannerS_BP3_13_6, ScannerS_BP3_H1H2_13_6)
