...
if __name__ == '__main__':
    ...
    ### 1D parameter plot for own grid 50 points
    ...
    ### 1D parameter plot for own grid 100 points

    # parameterData.mProcParameterMain(BP2_dictPointlistOwnGridRegion1,  'BP2', 'ownGridRegion1BP2_check_prel_100_TB', 100, 'check')
    # parameterData.mProcCalculatorMain('ownGridRegion1BP2_check_prel_100_TB', 'calc_ownGridRegion1BP2_check_prel_Mproc_100_TB', '/**/settings_*.json', 
    #                 SM1='bb', SM2='gamgam', generateH1H2=True)

    # parameterData.mProcParameterMain(BP2_dictPointlistOwnGridRegion2,  'BP2', 'ownGridRegion2BP2_check_prel_100_TB', 100, 'check')
